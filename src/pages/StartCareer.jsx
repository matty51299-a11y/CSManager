...
export default function StartCareer({ gameState, onBegin }) {
  ...
  if (!picking) return <div className="start-screen"><h1>CS Dynasty Manager</h1><p>Build an elite Counter-Strike dynasty through a season calendar of invites, Swiss stages, playoffs and ranking pressure.</p><button onClick={()=>setPicking(true)}>Start New Career</button></div>;
