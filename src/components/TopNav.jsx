...
const SECTIONS = [
  {
    ...
    label: 'Dashboard',
    home: '/',
    owns: ['/', '/fixtures', '/calendar', '/tournaments'],
    items: [['/', 'Overview'], ['/fixtures', 'Fixtures'], ['/calendar', 'Schedule']],
    tabs: [['/', 'Overview'], ['/fixtures', 'Fixtures'], ['/calendar', 'Schedule']],
  },
  {
    key: 'team',
    label: 'My Team',
  ...
  },
  {
    ...
    label: 'Statistics',
    home: '/rankings',
    owns: ['/rankings', '/teams', '/diagnostics'],
